...
(function($){
  ...
  theme.collectionTemplate = (function() {
    ...
    function updateScroll(animate) {
      var scrollTo = $('.collection-filter').offset().top;
      if (theme.config.stickyHeader) {
        var heightOfStickyNav = $('.site-header-sticky').outerHeight(true) + 10;
        scrollTo = scrollTo - heightOfStickyNav + 1;
      }
      if (animate) {
  ...
  theme.CollectionHeader = (function() {
    ...
    var selectors = {
      ...
      parallaxContainer: '.collection-hero__image-wrap'
    };
    ...
    function CollectionHeader(container) {
      ...
      var $heroImageContainer = this.heroImageContainer = this.$container.find(selectors.hero);
      if ($heroImageContainer.length) {
        if ($heroImageContainer.data('parallax')) {
          this.$parallaxContainer = this.$container.find(selectors.parallaxContainer);
          var args = {
            namespace: this.namespace
          };
          theme.parallaxSections[this.namespace] = new theme.Parallax(this.$parallaxContainer, args);
        }
      }
    }
  ...
  theme.SlideshowSection = (function() {
    ...
    var selectors = {
      parallaxContainer: '.hero-slideshow__container'
    };
  ...
  theme.BackgroundImage = (function() {
    ...
    var selectors = {
      parallaxContainer: '.background-media-text__container'
    };
  ...
  theme.Instagram = (function() {
    function Instagram(container) {
      ...
      var feed = this.feed = new Instafeed({
        ...
        userId: userId,
        limit: count + 2,
        template: '<div class="grid__item '+ gridItemWidth +'"><div class="image-wrap"><a href="{{link}}" class="lazyload insta-img" target="_blank" style="background-image: url({{image}}); display: block; padding-bottom: 100%; background-size: cover; background-position: center;"></a></div></div>',
